...
namespace gardian
{
    public partial class Int2 : Form
    {
        //variable que guarda el formulario de origen
        FMenuP parent;
        public Int2(FMenuP _parent)
        {
            parent = _parent;
            InitializeComponent();
        }

        private void Int2_Load(object sender, EventArgs e)
        {
        ...
        //variable memorama, 12 cartas, 6 imagenes
        Memorama memo = new Memorama(3,4);
        ...
        private void Int2_FormClosed(object sender, FormClosedEventArgs e)
        {
            Application.Exit();
        }
        ...
        private void btnCarta_Click(object sender, EventArgs e)
        {
            ...
            {
                //
                if (memo.CartasSeleccionadas.Count < 5)
                {
                    memo.movimientos++;
        ...
        //private void tmrvp_Tick(object sender, EventArgs e)
        //{
