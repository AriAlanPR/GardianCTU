...
namespace gardian
{
    public partial class Avan1 : Form
    {
        //variable que guarda el formulario de origen
        FMenuP parent;
        public Avan1(FMenuP _parent)
        {
            parent = _parent;
            InitializeComponent();
        }
        //variable usada para capturar los datos del juego
        Whack_A_Mole wam = new Whack_A_Mole(20);
        //loader del formulario
        private void Avan1_Load(object sender, EventArgs e)
        {
            for (var i = 0; i < 3; i++)//indica filas
            {
        ...
        private void Jugar(object sender, EventArgs e)
        {
            ...
            {
                if (Fichaseleccionadausuario.Tag.ToString() == "duck_" + wam.numeromarmotaactual)
                {
                    //sonido("bien");
                    //aumenta puntaje
                    wam.puntuacion++;
        ...
        private void Avan1_FormClosed(object sender, FormClosedEventArgs e)
        {
            Application.Exit();
        }
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            int rndi = wam.rnd.Next(0, 3);
            int rndj = wam.rnd.Next(0, 3);
            PictureBox pbx = this.Controls.Find(rndi + "_" + rndj, true).FirstOrDefault() as PictureBox;
            pbx.Image = (Bitmap)Properties.Resources.ResourceManager.GetObject("duck_" + rndtipo);
            //sonido("salidaanimal");
            pbx.Tag = "duck_" + rndtipo;
            //
            if (wam.fallas + wam.puntuacion == wam.limite) //antes fallas = limitefallas
            {
                ...
                Resultados res = new Resultados(wam.puntuacion, wam.fallas, wam.limite, "Avanzado", "Kinestesico");
        ...
        private void timer2_Tick(object sender, EventArgs e)
        {
            ...
            int Numeroanimal = wam.rnd.Next(1, 3);
            wam.numeromarmotaactual = Numeroanimal;
            pbxatrapame.Image = (Bitmap)Properties.Resources.ResourceManager.GetObject("duck_" + Numeroanimal);
        }
    }
}
